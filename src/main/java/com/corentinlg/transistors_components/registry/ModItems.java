...
public class ModItems {
  ...
  public static final BlockItem BIDIRECTIONNAL_REPEATER_BLOCK_ITEM = new BlockItem(ModBlocks.BIDIRECTIONNAL_REPEATER_BLOCK, new Item.Settings().group(ItemGroup.REDSTONE));
  ...
  public static void registerItems() {
    ...
    Registry.register(Registry.ITEM, new Identifier(TransistorsComponents.MOD_ID, "bidirectionnal_repeater_block"), BIDIRECTIONNAL_REPEATER_BLOCK_ITEM);
  }
}
