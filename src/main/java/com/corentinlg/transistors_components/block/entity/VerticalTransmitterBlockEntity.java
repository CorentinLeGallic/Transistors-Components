...
public class VerticalTransmitterBlockEntity extends BlockEntity {
  private int outputSignal;

  public VerticalTransmitterBlockEntity() {
    super(ModBlockEntityTypes.VERTICAL_TRANSMITTER_BLOCK_ENTITY_TYPE);
  }
